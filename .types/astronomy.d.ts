declare module 'meteor/jagi:astronomy' {
    ...
    interface ClassStatic extends AstronomyStatic<Class> {
        ...
        find(selectorOrWhateverMongoNormallyTakes: any, options?: any): any;
        findOne(selectorOrWhateverMongoNormallyTakes: any, options?: any): any;
        raw(): any;
    }
    ...
    export let Validator: ValidatorStatic;
}
